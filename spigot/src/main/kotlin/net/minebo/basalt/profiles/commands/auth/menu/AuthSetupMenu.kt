package net.minebo.basalt.profiles.commands.auth.menu
...
import net.minebo.basalt.util.totp.TOTPUtil
...
class AuthSetupMenu(val player: Player) : Menu(player)
{
    ...
    override fun getButtons(player: Player): MutableMap<Int, Button>
    {
        ...
        buttons[30] = SimpleActionButton(
            ...
            BasaltSpigotPlugin.instance.audience.player(player).sendMessage(troublesComponent)
        }
