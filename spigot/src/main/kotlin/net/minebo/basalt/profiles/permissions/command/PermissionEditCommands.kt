...
import net.minebo.basalt.util.PaginatedOutput
...
class PermissionEditCommands : BaseCommand()
{
    ...
    @CommandPermission("basalt.command.addpermission")
    ...
    @CommandPermission("basalt.command.listpermissions")
    @CommandCompletion("@gameprofile")
    ...
    @CommandPermission("basalt.command.deletepermission")
    @CommandCompletion("@gameprofile")
