...
import net.minebo.basalt.commands.rank.menu.RankEditorMenu
...
import net.minebo.basalt.profiles.permissions.packet.PermissionUpdateAllPacket
...
class GenericRankCommands : BaseCommand()
{
    ...
    fun setRankWoolColor(sender: CommandSender, @Name("rank") rank: Rank, @Name("wool color") newWoolColor: String)
    {
        ...
        val woolColor = BasaltAPI.getWoolColorStrict(newWoolColor)
