...
import net.minebo.basalt.convert.IRankConverter
                ...
                userSet.forEach { uuid ->
                    provider.userManager.loadUser(uuid).thenAcceptAsync { user ->
                        ...
                        if (rank != null)
                        {
                            ...
                            }.runTask(BasaltSpigotPlugin.instance)
                        }
                    }
                }
            }

            player.sendMessage(Chat.format("&e&lCAUTION! &cYou may need to set a default rank because Basalt cannot directly identify"))
