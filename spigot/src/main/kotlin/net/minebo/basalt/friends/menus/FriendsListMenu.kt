...
import net.minebo.basalt.friends.filter.button.FilterButton
    ...
    PaginatedMenu(18, player)
{
    ...
    class FriendButton(val profile: GameProfile) : Button()
    {
        ...
        override fun getDescription(player: Player): MutableList<String>
        {
            ...
            val rank = BasaltAPI.findRank(profile.uuid)
        ...
        {
            val name = Chat.format(BasaltAPI.getRankDisplay(profile.uuid))
