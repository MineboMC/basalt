...
import net.minebo.basalt.disguise.commands.menu.skin.DisguiseSelectNameMenu
...
object DisguiseCommand : BaseCommand()
{
    ...
    @CommandPermission("basalt.disguise.reveal")
    ...
    @CommandPermission("basalt.disguise")
    ...
    @CommandPermission("basalt.disguise.manual")
    fun onManualDisguise(player: Player, @Name("name") name: String)
    {
        if (!player.hasPermission("basalt.disguise.custom.unrestricted"))
        {
