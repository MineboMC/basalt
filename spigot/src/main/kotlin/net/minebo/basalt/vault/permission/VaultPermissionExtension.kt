...
import net.minebo.basalt.vault.chat.VaultChatExtension
...
class VaultPermissionExtension : Permission()
{
    ...
    private val basalt: BasaltSpigotPlugin = BasaltSpigotPlugin.instance
    fun init()
    {
        this.plugin = basalt
    ...
    {
        throw UnsupportedOperationException("Basalt does not allow for non-core group auditing!")
    }
