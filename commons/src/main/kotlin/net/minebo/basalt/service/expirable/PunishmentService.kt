...
object PunishmentService : ExpiringService<Punishment>() {
    ...
    var handler = Basalt.dataHandler.createStoreType<UUID, Punishment>(Basalt.getDataStoreMethod())

    val collection = Basalt.MongoConnectionPool.getCollection("punishment")
    ...
    fun findExecutorPunishments(executor: UUID) : List<Punishment>
    {
        ...
        {
            val model = Basalt.gson.fromJson(document.toJson(), Punishment::class.java)
    ...
    fun searchFromId(punishmentId: String) : Punishment?
    {
        ...
        return Basalt.gson.fromJson(bson.toJson(), Punishment::class.java)
    }
    ...
    fun findByTarget(target: UUID) : CompletableFuture<MutableList<Punishment>> {
        return CompletableFuture.supplyAsync {
            ...
            for (rawDoc in sorted)
            {
                ...
                val gson = Basalt.gson.fromJson(json, Punishment::class.java)
